...
`ifdef WARP
`define CY_BLK_DIR "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_SPI_Master_v2_50"
`include "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_SPI_Master_v2_50\B_SPI_Master_v2_50.v"
`else
`define CY_BLK_DIR "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_SPI_Master_v2_50"
`include "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_SPI_Master_v2_50\B_SPI_Master_v2_50.v"
`endif
...
module UART_v2_50_2 (
	...
	cy_clock_v1_0
		#(.id("89386df7-0ab3-415a-990a-ddfab6d170b6/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("b3cdffa0-98d2-48c4-b069-034fce96db03"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("6c373b0d-29d7-436a-87fc-94d1121a79c3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__KeyLeft_Button_1_net;
	wire [0:0] tmpFB_0__KeyLeft_Button_1_net;
	wire [0:0] tmpIO_0__KeyLeft_Button_1_net;
	wire [0:0] tmpINTERRUPT_0__KeyLeft_Button_1_net;
	electrical [0:0] tmpSIOVREF__KeyLeft_Button_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		KeyLeft_Button_1
		 (.oe(tmpOE__KeyLeft_Button_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__KeyLeft_Button_1_net[0:0]}),
		  .io({tmpIO_0__KeyLeft_Button_1_net[0:0]}),
		  .siovref(tmpSIOVREF__KeyLeft_Button_1_net),
		  .interrupt({tmpINTERRUPT_0__KeyLeft_Button_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__KeyLeft_Button_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__KeyRight_Button_2_net;
	wire [0:0] tmpFB_0__KeyRight_Button_2_net;
	wire [0:0] tmpIO_0__KeyRight_Button_2_net;
	wire [0:0] tmpINTERRUPT_0__KeyRight_Button_2_net;
	electrical [0:0] tmpSIOVREF__KeyRight_Button_2_net;

	cy_psoc3_pins_v1_10
		#(.id("4e41b9f7-89eb-4e78-91d8-58545d1b6406"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		KeyRight_Button_2
		 (.oe(tmpOE__KeyRight_Button_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__KeyRight_Button_2_net[0:0]}),
		  .io({tmpIO_0__KeyRight_Button_2_net[0:0]}),
		  .siovref(tmpSIOVREF__KeyRight_Button_2_net),
		  .interrupt({tmpINTERRUPT_0__KeyRight_Button_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__KeyRight_Button_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
