...
/**
 * Initializes all the font and clock values
 * @param none
 * @return none
 */  
...
/**
 * This wrapper function calls the STATE_processEvent function.
 * @param STATE_event_t event: takes an event like KL, KR, KRLP, 250MS, 1min
 * @return none
 */ 
